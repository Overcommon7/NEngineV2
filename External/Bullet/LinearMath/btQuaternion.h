...
public:
	...
	operator NEngine::NMath::Quaternion() const { return NEngine::NMath::Quaternion(m_floats[0], m_floats[1], m_floats[2], m_floats[3]); }
	btQuaternion& operator=(const NEngine::NMath::Quaternion& v) { m_floats[0] = v.x, m_floats[1] = v.y, m_floats[2] = v.z; m_floats[3] = v.w;  return *this; }
	btQuaternion(const NEngine::NMath::Quaternion& v) { m_floats[0] = v.x, m_floats[1] = v.y, m_floats[2] = v.z; m_floats[3] = v.w; }

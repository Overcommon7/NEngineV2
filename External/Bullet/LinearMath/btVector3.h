...
public:
	...
	operator NEngine::NMath::Vector3() const { return NEngine::NMath::Vector3(m_floats[0], m_floats[1], m_floats[2]); }
	btVector3& operator=(const NEngine::NMath::Vector3& v) { m_floats[0] = v.x, m_floats[1] = v.y, m_floats[2] = v.z; return *this; }
	btVector3(const NEngine::NMath::Vector3& v) { m_floats[0] = v.x, m_floats[1] = v.y, m_floats[2] = v.z; }
